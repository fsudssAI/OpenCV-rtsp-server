...
class QCar():
    ...
    def read_IMU(self):
        ...
        try:
            ...
            return self.read_other_buffer_gyroscope, self.read_other_buffer_accelerometer 
    ...
    def write_mtrs(self, mtr_cmd,sat_pwm=0.2, sat_str=0.5):
        '''Use this to write motor commands\n
        INPUTS:
        mtr_cmd - numpy 1x2 array of throttle (%) and steering (rad) motor commands. '''
    
        self.write_pwm_buffer_throttle[0] = -saturate(mtr_cmd[0], sat_pwm, -1.0 * sat_pwm)
        self.write_other_buffer_steering[0] = -saturate(mtr_cmd[1], sat_str, -1.0 * sat_str)
        ...
        try:
            ...
            print(h.get_error_message())
        return self.write_pwm_buffer_throttle[0]
    ...
    def write_std(self, mtr_cmd, LEDs,sat_pwm=0.2, sat_str=0.5):
        ...
        self.write_pwm_buffer_throttle[0] = -saturate(mtr_cmd[0], sat_pwm, -1.0*sat_pwm)
        self.write_other_buffer_str_LEDs[0] = -saturate(mtr_cmd[1], sat_str, -1.0*sat_str)
    ...
    def read_write_std(self, mtr_cmd, LEDs,sat_pwm=0.2, sat_str=0.5):
